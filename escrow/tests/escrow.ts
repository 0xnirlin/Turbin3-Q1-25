...
describe("escrow", () => {
  ...
  before(async () => {
    // we get the solana aridrop for the maker and tha taker. 
    ...
    // than we create the mint accounts for two tokens. 
    ...
    // we create the maker ata's for both the tokens. 
    ...
    // we create the taker ata for both the tokens. 
    ...
    // than we mint tokens to the maker and taker ata's.  - each - we don't want to mint both since these will be swapped into each other. 
